...
r = requests.post('http://localhost:8000/comments/ViewComments/',json={'BookID':1})
print('Result :')
print(r.json())
...
print('Starting the comment request...')
r = requests.post('http://localhost:8000/comments/ViewComments/',json={'BookID':1},headers=hed)
print('Result :')
print(r.json())
print('status code : ' + str(r.status_code)+'\n')
...
hed = {'Authorization':'Bearer '+access}
print('Starting the comment request...')
r = requests.post('http://localhost:8000/comments/ViewComments/',json={'BookID':243},headers=hed)
print('Result :')
print(r.json())
print('status code : ' + str(r.status_code)+'\n')
