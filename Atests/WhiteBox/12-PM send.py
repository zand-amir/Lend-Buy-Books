...
r = requests.post('http://localhost:8000/api/User/SendMessage/25/',json={"Text":"Message Text!"})
print('result :')
print(r.json())
...
print('Sending the request ...')
r = requests.post('http://localhost:8000/api/User/SendMessage/25/',json={"Text":"Message Text!"},headers=hed)
print('result :')
print(r.json())
print('status code : '+str(r.status_code)+'\n')
...
hed = {'Authorization':'Bearer '+access}
print('Sending the request ...')
r = requests.post('http://localhost:8000/api/User/SendMessage/1/',json={"Text":"Message Text!"},headers=hed)
print('result :')
print(r.json())
print('status code : '+str(r.status_code)+'\n')
