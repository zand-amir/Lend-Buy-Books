...
req_body = {'Descriptions': 'loaning the book!', 'books': ['1']}
print('starting request...')
r = requests.post('http://localhost:8000/api/Books/Book-BorrowOffer/',headers=hed,json = req_body)
print('result:')
print (r.json())
...
req_body = {'Descriptions': 'loaning the book!', 'books': ['1']}
print('starting request...')
r = requests.post('http://localhost:8000/api/Books/Book-BorrowOffer/',json = req_body)
print('result:')
print (r.json())
print('status code : ' + str(r.status_code)+'\n')
...
access = r.json()['access']
hed = {'Authorization':'Bearer '+access}
req_body = {'Descriptions': 'loaning the book!', 'books': ['243']}
print('starting request...')
r = requests.post('http://localhost:8000/api/Books/Book-BorrowOffer/',headers=hed,json = req_body)
print('result:')
print (r.json())
